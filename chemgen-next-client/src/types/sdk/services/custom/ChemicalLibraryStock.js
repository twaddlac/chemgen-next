...
/**
 * Api services for the `ChemicalLibraryStockResultSet` model.
 */
var ChemicalLibraryStockApi = /** @class */ (function (_super) {
    __extends(ChemicalLibraryStockApi, _super);
    function ChemicalLibraryStockApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ChemicalLibraryStockResultSet` object.)
     * </em>
     */
    ChemicalLibraryStockApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ChemicalLibraryStocks";
        var _routeParams = {};
        var _postBody = {
            data: data
        };
     ...
     *
     * @param {any} id ChemicalLibraryStock id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ChemicalLibraryStockApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ChemicalLibraryStocks/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    ChemicalLibraryStockApi.prototype.getModelName = function () {
        return "ChemicalLibraryStockResultSet";
    };
    ChemicalLibraryStockApi = __decorate([
        core_1.Injectable(),
    ...
    return ChemicalLibraryStockApi;
}(base_service_1.BaseLoopBackApi));
exports.ChemicalLibraryStockApi = ChemicalLibraryStockApi;
