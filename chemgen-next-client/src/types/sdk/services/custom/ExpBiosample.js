...
/**
 * Api services for the `ExpBiosampleResultSet` model.
 */
var ExpBiosampleApi = /** @class */ (function (_super) {
    __extends(ExpBiosampleApi, _super);
    function ExpBiosampleApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpBiosampleResultSet` object.)
     * </em>
     */
    ExpBiosampleApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ExpBiosampleApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpBiosamples/:id";
     ...
     */
    ExpBiosampleApi.prototype.getModelName = function () {
        return "ExpBiosampleResultSet";
    };
    ExpBiosampleApi = __decorate([
        core_1.Injectable(),
    ...
    return ExpBiosampleApi;
}(base_service_1.BaseLoopBackApi));
exports.ExpBiosampleApi = ExpBiosampleApi;
//# sourceMappingURL=ExpBiosample.js.map