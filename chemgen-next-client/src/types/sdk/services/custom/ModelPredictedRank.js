...
/**
 * Api services for the `ModelPredictedRankResultSet` model.
 */
var ModelPredictedRankApi = /** @class */ (function (_super) {
    __extends(ModelPredictedRankApi, _super);
    function ModelPredictedRankApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ModelPredictedRankResultSet` object.)
     * </em>
     */
    ModelPredictedRankApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ModelPredictedRank id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ModelPredictedRankApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ModelPredictedRanks/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    ModelPredictedRankApi.prototype.getModelName = function () {
        return "ModelPredictedRankResultSet";
    };
    ModelPredictedRankApi = __decorate([
        core_1.Injectable(),
    ...
    return ModelPredictedRankApi;
}(base_service_1.BaseLoopBackApi));
exports.ModelPredictedRankApi = ModelPredictedRankApi;
//# sourceMappingURL=ModelPredictedRank.js.map