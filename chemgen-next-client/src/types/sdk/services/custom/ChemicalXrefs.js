...
/**
 * Api services for the `ChemicalXrefsResultSet` model.
 */
var ChemicalXrefsApi = /** @class */ (function (_super) {
    __extends(ChemicalXrefsApi, _super);
    function ChemicalXrefsApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ChemicalXrefsResultSet` object.)
     * </em>
     */
    ChemicalXrefsApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ChemicalXrefsApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ChemicalXrefs/:id";
     ...
     */
    ChemicalXrefsApi.prototype.getModelName = function () {
        return "ChemicalXrefsResultSet";
    };
    ChemicalXrefsApi = __decorate([
        core_1.Injectable(),
    ...
    return ChemicalXrefsApi;
}(base_service_1.BaseLoopBackApi));
exports.ChemicalXrefsApi = ChemicalXrefsApi;
