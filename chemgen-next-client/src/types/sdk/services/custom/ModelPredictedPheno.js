...
var ModelPredictedPhenoApi = /** @class */ (function (_super) {
     ...
     * This usually means the response is a `ModelPredictedPhenoResultSet` object.)
     * </em>
     */
    ModelPredictedPhenoApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ModelPredictedPhenos";
        var _routeParams = {};
        var _postBody = {
            data: data
        };
     ...
     *
     * @param {any} id ModelPredictedPheno id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ModelPredictedPhenoApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ModelPredictedPhenos/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    ModelPredictedPhenoApi.prototype.getModelName = function () {
...
exports.ModelPredictedPhenoApi = ModelPredictedPhenoApi;
