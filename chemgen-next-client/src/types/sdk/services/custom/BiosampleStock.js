...
/**
 * Api services for the `BiosampleStockResultSet` model.
 */
var BiosampleStockApi = /** @class */ (function (_super) {
    __extends(BiosampleStockApi, _super);
    function BiosampleStockApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `BiosampleStockResultSet` object.)
     * </em>
     */
    BiosampleStockApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id BiosampleStock id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    BiosampleStockApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/BiosampleStocks/:id";
     ...
     */
    BiosampleStockApi.prototype.getModelName = function () {
        return "BiosampleStockResultSet";
    };
    BiosampleStockApi = __decorate([
        core_1.Injectable(),
    ...
    return BiosampleStockApi;
}(base_service_1.BaseLoopBackApi));
exports.BiosampleStockApi = BiosampleStockApi;
//# sourceMappingURL=BiosampleStock.js.map