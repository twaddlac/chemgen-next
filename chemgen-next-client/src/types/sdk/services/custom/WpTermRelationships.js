...
/**
 * Api services for the `WpTermRelationshipsResultSet` model.
 */
var WpTermRelationshipsApi = /** @class */ (function (_super) {
    __extends(WpTermRelationshipsApi, _super);
    function WpTermRelationshipsApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `WpTermRelationshipsResultSet` object.)
     * </em>
     */
    WpTermRelationshipsApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id WpTermRelationships id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    WpTermRelationshipsApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/WpTermRelationships/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    WpTermRelationshipsApi.prototype.getModelName = function () {
        return "WpTermRelationshipsResultSet";
    };
    WpTermRelationshipsApi = __decorate([
        core_1.Injectable(),
    ...
    return WpTermRelationshipsApi;
}(base_service_1.BaseLoopBackApi));
exports.WpTermRelationshipsApi = WpTermRelationshipsApi;
