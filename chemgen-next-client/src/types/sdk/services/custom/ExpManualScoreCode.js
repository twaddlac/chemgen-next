...
/**
 * Api services for the `ExpManualScoreCodeResultSet` model.
 */
var ExpManualScoreCodeApi = /** @class */ (function (_super) {
    __extends(ExpManualScoreCodeApi, _super);
    function ExpManualScoreCodeApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpManualScoreCodeResultSet` object.)
     * </em>
     */
    ExpManualScoreCodeApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ExpManualScoreCode id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ExpManualScoreCodeApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpManualScoreCodes/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    ExpManualScoreCodeApi.prototype.getModelName = function () {
        return "ExpManualScoreCodeResultSet";
    };
    ExpManualScoreCodeApi = __decorate([
        core_1.Injectable(),
    ...
    return ExpManualScoreCodeApi;
}(base_service_1.BaseLoopBackApi));
exports.ExpManualScoreCodeApi = ExpManualScoreCodeApi;
//# sourceMappingURL=ExpManualScoreCode.js.map