...
/**
 * Api services for the `ModelsResultSet` model.
 */
var ModelsApi = /** @class */ (function (_super) {
    __extends(ModelsApi, _super);
    function ModelsApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ModelsResultSet` object.)
     * </em>
     */
    ModelsApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ModelsApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Models/:id";
     ...
     * i.e. `ModelsResultSet`.
     */
    ModelsApi.prototype.getModelName = function () {
        return "ModelsResultSet";
    };
    ModelsApi = __decorate([
        core_1.Injectable(),
