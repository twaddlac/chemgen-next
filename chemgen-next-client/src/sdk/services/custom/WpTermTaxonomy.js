...
/**
 * Api services for the `WpTermTaxonomyResultSet` model.
 */
var WpTermTaxonomyApi = /** @class */ (function (_super) {
    __extends(WpTermTaxonomyApi, _super);
    function WpTermTaxonomyApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `WpTermTaxonomyResultSet` object.)
     * </em>
     */
    WpTermTaxonomyApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id WpTermTaxonomy id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    WpTermTaxonomyApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/WpTermTaxonomies/:id";
     ...
     */
    WpTermTaxonomyApi.prototype.getModelName = function () {
        return "WpTermTaxonomyResultSet";
    };
    WpTermTaxonomyApi = __decorate([
        core_1.Injectable(),
    ...
    return WpTermTaxonomyApi;
}(base_service_1.BaseLoopBackApi));
exports.WpTermTaxonomyApi = WpTermTaxonomyApi;
