...
/**
 * Api services for the `RnaiWormbaseXrefsResultSet` model.
 */
var RnaiWormbaseXrefsApi = /** @class */ (function (_super) {
    __extends(RnaiWormbaseXrefsApi, _super);
    function RnaiWormbaseXrefsApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `RnaiWormbaseXrefsResultSet` object.)
     * </em>
     */
    RnaiWormbaseXrefsApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id RnaiWormbaseXrefs id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    RnaiWormbaseXrefsApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiWormbaseXrefs/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    RnaiWormbaseXrefsApi.prototype.getModelName = function () {
        return "RnaiWormbaseXrefsResultSet";
    };
    RnaiWormbaseXrefsApi = __decorate([
        core_1.Injectable(),
    ...
    return RnaiWormbaseXrefsApi;
}(base_service_1.BaseLoopBackApi));
exports.RnaiWormbaseXrefsApi = RnaiWormbaseXrefsApi;
