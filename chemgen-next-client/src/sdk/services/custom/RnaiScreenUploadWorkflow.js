...
/**
 * Api services for the `RnaiScreenUploadWorkflowResultSet` model.
 */
var RnaiScreenUploadWorkflowApi = /** @class */ (function (_super) {
    __extends(RnaiScreenUploadWorkflowApi, _super);
    function RnaiScreenUploadWorkflowApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `RnaiScreenUploadWorkflowResultSet` object.)
     * </em>
     */
    RnaiScreenUploadWorkflowApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiScreenUploadWorkflows";
        var _routeParams = {};
        var _postBody = {
            data: data
        };
     ...
     *
     * @param {any} id RnaiScreenUploadWorkflow id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    RnaiScreenUploadWorkflowApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiScreenUploadWorkflows/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    RnaiScreenUploadWorkflowApi.prototype.getModelName = function () {
        return "RnaiScreenUploadWorkflowResultSet";
    };
    RnaiScreenUploadWorkflowApi = __decorate([
        core_1.Injectable(),
    ...
    return RnaiScreenUploadWorkflowApi;
}(base_service_1.BaseLoopBackApi));
exports.RnaiScreenUploadWorkflowApi = RnaiScreenUploadWorkflowApi;
//# sourceMappingURL=RnaiScreenUploadWorkflow.js.map