...
/**
 * Api services for the `RnaiLibraryStockResultSet` model.
 */
var RnaiLibraryStockApi = /** @class */ (function (_super) {
    __extends(RnaiLibraryStockApi, _super);
    function RnaiLibraryStockApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `RnaiLibraryStockResultSet` object.)
     * </em>
     */
    RnaiLibraryStockApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id RnaiLibraryStock id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    RnaiLibraryStockApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiLibraryStocks/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    RnaiLibraryStockApi.prototype.getModelName = function () {
        return "RnaiLibraryStockResultSet";
    };
    RnaiLibraryStockApi = __decorate([
        core_1.Injectable(),
    ...
    return RnaiLibraryStockApi;
}(base_service_1.BaseLoopBackApi));
exports.RnaiLibraryStockApi = RnaiLibraryStockApi;
