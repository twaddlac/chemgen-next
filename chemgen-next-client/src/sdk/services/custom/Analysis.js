...
/**
 * Api services for the `AnalysisResultSet` model.
 */
var AnalysisApi = /** @class */ (function (_super) {
    __extends(AnalysisApi, _super);
    function AnalysisApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `AnalysisResultSet` object.)
     * </em>
     */
    AnalysisApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    AnalysisApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Analyses/:id";
     ...
     */
    AnalysisApi.prototype.getModelName = function () {
        return "AnalysisResultSet";
    };
    AnalysisApi = __decorate([
        core_1.Injectable(),
