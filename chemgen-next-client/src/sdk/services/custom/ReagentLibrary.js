...
/**
 * Api services for the `ReagentLibraryResultSet` model.
 */
var ReagentLibraryApi = /** @class */ (function (_super) {
    __extends(ReagentLibraryApi, _super);
    function ReagentLibraryApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ReagentLibraryResultSet` object.)
     * </em>
     */
    ReagentLibraryApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ReagentLibrary id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ReagentLibraryApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ReagentLibraries/:id";
     ...
     */
    ReagentLibraryApi.prototype.getModelName = function () {
        return "ReagentLibraryResultSet";
    };
    ReagentLibraryApi = __decorate([
        core_1.Injectable(),
    ...
    return ReagentLibraryApi;
}(base_service_1.BaseLoopBackApi));
exports.ReagentLibraryApi = ReagentLibraryApi;
//# sourceMappingURL=ReagentLibrary.js.map