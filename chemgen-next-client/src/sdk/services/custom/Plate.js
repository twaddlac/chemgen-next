...
/**
 * Api services for the `PlateResultSet` model.
 */
var PlateApi = /** @class */ (function (_super) {
    __extends(PlateApi, _super);
    function PlateApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `PlateResultSet` object.)
     * </em>
     */
    PlateApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    PlateApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/Plates/:id";
     ...
     * i.e. `PlateResultSet`.
     */
    PlateApi.prototype.getModelName = function () {
