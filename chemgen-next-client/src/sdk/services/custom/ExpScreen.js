...
/**
 * Api services for the `ExpScreenResultSet` model.
 */
var ExpScreenApi = /** @class */ (function (_super) {
    __extends(ExpScreenApi, _super);
    function ExpScreenApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpScreenResultSet` object.)
     * </em>
     */
    ExpScreenApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ExpScreenApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpScreens/:id";
     ...
     */
    ExpScreenApi.prototype.getModelName = function () {
        return "ExpScreenResultSet";
    };
    ExpScreenApi = __decorate([
        core_1.Injectable(),
...
exports.ExpScreenApi = ExpScreenApi;
//# sourceMappingURL=ExpScreen.js.map