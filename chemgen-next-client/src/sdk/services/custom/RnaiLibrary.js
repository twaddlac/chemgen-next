...
/**
 * Api services for the `RnaiLibraryResultSet` model.
 */
var RnaiLibraryApi = /** @class */ (function (_super) {
    __extends(RnaiLibraryApi, _super);
    function RnaiLibraryApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `RnaiLibraryResultSet` object.)
     * </em>
     */
    RnaiLibraryApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    RnaiLibraryApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiLibraries/:id";
     ...
     */
    RnaiLibraryApi.prototype.getModelName = function () {
        return "RnaiLibraryResultSet";
    };
    RnaiLibraryApi = __decorate([
        core_1.Injectable(),
    ...
    return RnaiLibraryApi;
}(base_service_1.BaseLoopBackApi));
exports.RnaiLibraryApi = RnaiLibraryApi;
