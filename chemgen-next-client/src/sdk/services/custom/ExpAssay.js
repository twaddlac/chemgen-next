...
/**
 * Api services for the `ExpAssayResultSet` model.
 */
var ExpAssayApi = /** @class */ (function (_super) {
    __extends(ExpAssayApi, _super);
    function ExpAssayApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpAssayResultSet` object.)
     * </em>
     */
    ExpAssayApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ExpAssayApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpAssays/:id";
     ...
     */
    ExpAssayApi.prototype.getModelName = function () {
        return "ExpAssayResultSet";
    };
    ExpAssayApi = __decorate([
        core_1.Injectable(),
...
exports.ExpAssayApi = ExpAssayApi;
