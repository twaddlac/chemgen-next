...
/**
 * Api services for the `ExpDesignResultSet` model.
 */
var ExpDesignApi = /** @class */ (function (_super) {
    __extends(ExpDesignApi, _super);
    function ExpDesignApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpDesignResultSet` object.)
     * </em>
     */
    ExpDesignApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ExpDesignApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpDesigns/:id";
     ...
     *  - `results` – `{any}` -
     */
    ExpDesignApi.prototype.getExpSets = function (search, customHeaders) {
        if (search === void 0) { search = {}; }
        var _method = "POST";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpDesigns/getExpSets";
        var _routeParams = {};
        var _postBody = {};
        var _urlParams = {};
     ...
     */
    ExpDesignApi.prototype.getModelName = function () {
        return "ExpDesignResultSet";
    };
    ExpDesignApi = __decorate([
        core_1.Injectable(),
...
exports.ExpDesignApi = ExpDesignApi;
