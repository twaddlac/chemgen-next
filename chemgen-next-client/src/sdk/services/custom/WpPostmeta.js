...
/**
 * Api services for the `WpPostmetaResultSet` model.
 */
var WpPostmetaApi = /** @class */ (function (_super) {
    __extends(WpPostmetaApi, _super);
    function WpPostmetaApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `WpPostmetaResultSet` object.)
     * </em>
     */
    WpPostmetaApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    WpPostmetaApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/WpPostmeta/:id";
     ...
     */
    WpPostmetaApi.prototype.getModelName = function () {
        return "WpPostmetaResultSet";
    };
    WpPostmetaApi = __decorate([
        core_1.Injectable(),
    ...
    return WpPostmetaApi;
}(base_service_1.BaseLoopBackApi));
exports.WpPostmetaApi = WpPostmetaApi;
//# sourceMappingURL=WpPostmeta.js.map