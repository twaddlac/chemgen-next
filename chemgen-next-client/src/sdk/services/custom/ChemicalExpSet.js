...
/**
 * Api services for the `ChemicalExpSetResultSet` model.
 */
var ChemicalExpSetApi = /** @class */ (function (_super) {
    __extends(ChemicalExpSetApi, _super);
    function ChemicalExpSetApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ChemicalExpSetResultSet` object.)
     * </em>
     */
    ChemicalExpSetApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ChemicalExpSet id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ChemicalExpSetApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ChemicalExpSets/:id";
     ...
     */
    ChemicalExpSetApi.prototype.getModelName = function () {
        return "ChemicalExpSetResultSet";
    };
    ChemicalExpSetApi = __decorate([
        core_1.Injectable(),
    ...
    return ChemicalExpSetApi;
}(base_service_1.BaseLoopBackApi));
exports.ChemicalExpSetApi = ChemicalExpSetApi;
//# sourceMappingURL=ChemicalExpSet.js.map