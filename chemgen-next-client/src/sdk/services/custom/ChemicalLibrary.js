...
/**
 * Api services for the `ChemicalLibraryResultSet` model.
 */
var ChemicalLibraryApi = /** @class */ (function (_super) {
    __extends(ChemicalLibraryApi, _super);
    function ChemicalLibraryApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ChemicalLibraryResultSet` object.)
     * </em>
     */
    ChemicalLibraryApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     *
     * @param {any} id ChemicalLibrary id
     *
     * @param {object} data Request data.
     *
     ...
     * </em>
     */
    ChemicalLibraryApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ChemicalLibraries/:id";
        var _routeParams = {
            id: id
        };
        var _postBody = {
     ...
     */
    ChemicalLibraryApi.prototype.getModelName = function () {
        return "ChemicalLibraryResultSet";
    };
    ChemicalLibraryApi = __decorate([
        core_1.Injectable(),
    ...
    return ChemicalLibraryApi;
}(base_service_1.BaseLoopBackApi));
exports.ChemicalLibraryApi = ChemicalLibraryApi;
