...
/**
 * Api services for the `ExpGroupResultSet` model.
 */
var ExpGroupApi = /** @class */ (function (_super) {
    __extends(ExpGroupApi, _super);
    function ExpGroupApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `ExpGroupResultSet` object.)
     * </em>
     */
    ExpGroupApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    ExpGroupApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/ExpGroups/:id";
     ...
     */
    ExpGroupApi.prototype.getModelName = function () {
        return "ExpGroupResultSet";
    };
    ExpGroupApi = __decorate([
        core_1.Injectable(),
...
exports.ExpGroupApi = ExpGroupApi;
