...
/**
 * Api services for the `RnaiExpSetResultSet` model.
 */
var RnaiExpSetApi = /** @class */ (function (_super) {
    __extends(RnaiExpSetApi, _super);
    function RnaiExpSetApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `RnaiExpSetResultSet` object.)
     * </em>
     */
    RnaiExpSetApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    RnaiExpSetApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiExpSets/:id";
     ...
     *  - `results` – `{any}` -
     */
    RnaiExpSetApi.prototype.getExpSetsByGenesList = function (search, customHeaders) {
        if (search === void 0) { search = {}; }
        var _method = "POST";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiExpSets/getExpSetsByGenesList";
        var _routeParams = {};
        var _postBody = {};
        var _urlParams = {};
     ...
     *  - `results` – `{any}` -
     */
    RnaiExpSetApi.prototype.getExpSets = function (search, customHeaders) {
        if (search === void 0) { search = {}; }
        var _method = "POST";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/RnaiExpSets/getExpSets";
        var _routeParams = {};
        var _postBody = {};
        var _urlParams = {};
        if (typeof search !== 'undefined' && search !== null)
     ...
     */
    RnaiExpSetApi.prototype.getModelName = function () {
        return "RnaiExpSetResultSet";
    };
    RnaiExpSetApi = __decorate([
        core_1.Injectable(),
    ...
    return RnaiExpSetApi;
}(base_service_1.BaseLoopBackApi));
exports.RnaiExpSetApi = RnaiExpSetApi;
