...
/**
 * Api services for the `WpTermsResultSet` model.
 */
var WpTermsApi = /** @class */ (function (_super) {
    __extends(WpTermsApi, _super);
    function WpTermsApi(http, connection, models, auth, errorHandler) {
     ...
     * This usually means the response is a `WpTermsResultSet` object.)
     * </em>
     */
    WpTermsApi.prototype.patchOrCreate = function (data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
     ...
     * </em>
     */
    WpTermsApi.prototype.patchAttributes = function (id, data, customHeaders) {
        if (data === void 0) { data = {}; }
        var _method = "PATCH";
        var _url = lb_config_1.LoopBackConfig.getPath() + "/" + lb_config_1.LoopBackConfig.getApiVersion() +
            "/WpTerms/:id";
     ...
     */
    WpTermsApi.prototype.getModelName = function () {
        return "WpTermsResultSet";
    };
    WpTermsApi = __decorate([
        core_1.Injectable(),
