...
export class ExpsetModule {
  ...
  getExpSet(wellCounts: ModelPredictedCountsResultSet, expSets: any) {
    const o: any = {};
    ...
    if (!treatmentGroupId) {
      // console.log(`No treatmentGroupId!`);
      // console.log(JSON.stringify(this.expSets.results.expSets, null, 2));
